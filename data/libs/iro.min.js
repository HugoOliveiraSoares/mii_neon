...
!function (t, n) {
  ...
  function h(t, n, i) {
    ...
    if (n = M({}, n), 3 < arguments.length) {
      for (i = [i], r = 3; r < arguments.length; r++) {
        i.push(l[r]);
      }
    }
    if (
      null != i && (n.children = i), null != t && null != t.defaultProps
    ) {
            ...
            if (
              ...
              if (null == d && (d = h), null != t.l) h = t.l, t.l = null;
                ...
                t: if (null == l || l.parentNode !== n) n.appendChild(h);
                  ...
                  for (
                    v = l, a = 0; (v = v.nextSibling) && a < p; a += 2
                  ) if (v == h) break t;
                  n.insertBefore(h, l);
                }
  ...
  function f(t, n, i) {
    "-" === n[0]
      ? t.setProperty(n, i)
      : t[n] = "number" == typeof i && !1 === r.test(n)
        ? i + "px"
        : null == i
        ? ""
        : i;
  ...
  function R(t, n, i, r, e) {
    ...
    if (
      ...
      if (u = t.style, "string" == typeof i) u.cssText = i;
        ...
        ? t[n] = null == i ? "" : i
        : "function" != typeof i && "dangerouslySetInnerHTML" !== n &&
          (n !== (n = n.replace(/^xlink:?/, ""))
            ? null == i || !1 === i
              ? t.removeAttributeNS(
    ...
    try {
      t: if ("function" == typeof k) {
        if (
          p = n.props,
            ...
            i.c
              ...
              : ("prototype" in k && k.prototype.render
                ? n.c = f = new k(p, w)
                : (n.c = f = new I(p, w), f.constructor = k, f.render = z),
                y && y.sub(f),
                f.props = p,
                f.state || (f.state = {}),
                f.context = w,
          ...
          null == k.getDerivedStateFromProps && null != f.componentWillMount &&
          f.componentWillMount(), null != f.componentDidMount && o.push(f);
        } else {
          if (
            null == k.getDerivedStateFromProps && null == l &&
            null != f.componentWillReceiveProps &&
            f.componentWillReceiveProps(p, w),
              !l && null != f.shouldComponentUpdate &&
        ...
        for (
          v = f.props,
            ...
            h || null == f.getSnapshotBeforeUpdate ||
            (g = f.getSnapshotBeforeUpdate(v, d)),
            S(t, n, i, r, e, u, o, s, c),
            f.base = n.o;
          a = f.m.pop();
        ) f.j && (f.state = f.j), a.call(f);
        h || null == v || null == f.componentDidUpdate ||
        f.componentDidUpdate(v, d, g), b && (f.k = f.i = null);
          ...
          if (null == t) {
            ...
            t = e
              ...
              : document.createElement(n.type), u = null;
          }
          return null === n.type
            ? h !== v && (null != u && (u[u.indexOf(t)] = null), t.data = v)
            : n !== i && (null != u && (u = j.slice.call(t.childNodes)),
              a = (h = i.props || x).dangerouslySetInnerHTML,
              f = v.dangerouslySetInnerHTML,
              l ||
              (f || a) &&
                (f && a && f.O == a.O || (t.innerHTML = f && f.O || "")),
              function (t, n, i, r, e) {
                var u;
                for (u in i) u in n || R(t, u, null, i[u], r);
                for (u in n) {
                  e && "function" != typeof n[u] || "value" === u ||
                    "checked" === u || i[u] === n[u] || R(t, u, n[u], i[u], r);
                }
              }(t, v, h, e, l),
              n.n = n.props.children,
              f || S(t, n, i, r, "foreignObject" !== n.type && e, u, o, x, l),
              l ||
              ("value" in v && void 0 !== v.value && v.value !== t.value &&
                (t.value = null == v.value ? "" : v.value),
                "checked" in v && void 0 !== v.checked &&
                v.checked !== t.checked && (t.checked = v.checked))),
            t;
        }(i.o, n, i, r, e, u, o, c);}
      (a = m.diffed) && a(n);
    } catch (t) {
    ...
    m.o = function (t, n, i) {
      for (var r; n = n.i;) {
        if ((r = n.c) && !r.i) {
          try {
            if (
              r.constructor && null != r.constructor.getDerivedStateFromError
  ...
  function K(t, n) {
    var i = -1 < t.indexOf("%"), r = parseFloat(t);
    return i ? n / 100 * r : r;
  }
  function Q(t) {
  ...
  var V = function () {
    ...
    return t.set = function (t) {
      ...
      l.kelvinToRgb = function (t) {
        ...
        return r = e < 66
          ? (n = 255,
            i = -155.25485562709179 - .44596950469579133 * (i = e - 2) +
              104.49216199393888 * q(i),
            e < 20
              ? 0
              : .8274096064007395 * (r = e - 10) - 254.76935184120902 +
                115.67994401066147 * q(r))
          : (n = 351.97690566805693 + .114206453784165 * (n = e - 55) -
            40.25366309332127 * q(n),
            i = 325.4494125711974 + .07943456536662342 * (i = e - 50) -
      ...
      function (t, n, i) {
        ...
        key: "rgb",
        get: function () {
          var t = l.hsvToRgb(this.$), n = t.r, i = t.g, r = t.b;
        ...
        key: "hsl",
        get: function () {
          var t = l.hsvToHsl(this.$), n = t.h, i = t.s, r = t.l;
  ...
  function ot(t, n, i) {
    var r = t.wheelAngle, e = t.wheelDirection;
    return i && "clockwise" === e
      ? n = r + n
      : "clockwise" === e
      ? n = 360 - r + n
      : i && "anticlockwise" === e
  ...
  function lt(t, n, i) {
    var r = ut(t), e = r.cx, u = r.cy, o = et(t);
    n = e - n, i = u - i;
    var l = ot(t, Math.atan2(-i, -n) * (360 / nt)), s = Math.min(rt(n, i), o);
    return { h: Math.round(l), s: Math.round(100 / o * s) };
  }
  function st(t) {
    var n = t.width, i = t.boxHeight;
    return {
      width: n,
      height: null != i ? i : n,
  ...
  function bt(t) {
    var n = t.r, i = t.url, r = n, e = n;
    return h(
      "svg",
      {
        className: "IroHandle IroHandle--" + t.index + " " +
  ...
  function pt(e) {
    var t = e.activeIndex,
      ...
      c = function (t, n) {
        ...
        switch (t.sliderType) {
          case "red":
            return [[0, "rgb(0," + r.g + "," + r.b + ")"], [
              100,
              "rgb(255," + r.g + "," + r.b + ")",
            ]];
          case "green":
            return [[0, "rgb(" + r.r + ",0," + r.b + ")"], [
              100,
              "rgb(" + r.r + ",255," + r.b + ")",
            ]];
          case "blue":
            return [[0, "rgb(" + r.r + "," + r.g + ",0)"], [
              100,
              "rgb(" + r.r + "," + r.g + ",255)",
            ]];
          case "alpha":
            return [[0, "rgba(" + r.r + "," + r.g + "," + r.b + ",0)"], [
              100,
              "rgb(" + r.r + "," + r.g + "," + r.b + ")",
            ]];
          case "kelvin":
            for (
              ...
              var a = V.kelvinToRgb(s), f = a.r, h = a.g, v = a.b;
  ...
  function yt(e) {
    var t = st(e),
      ...
      a = function (t, n) {
        return [[[0, "#fff"], [100, "hsl(" + n.hue + ",100%,50%)"]], [[
          0,
          "rgba(0,0,0,0)",
        ], [100, "#000"]]];
      }(0, c),
      ...
      Object.assign({}, e, {
        onInput: function (t, n, i) {
          if (0 === i) {
            ...
            null !== r
              ? s.setActiveColor(r)
              : (s.inputActive = !0, c.hsv = ct(e, t, n), e.onInput(i, e.id));
        ...
        return h(
          ...
          h("div", {
            ...
            style: Object.assign(
              ...
              ft(e),
              {
                background: ht("linear", "to bottom", a[1]) + "," +
      ...
      Object.assign({}, e, {
        onInput: function (t, n, i) {
          if (0 === i) {
            if (
              !function (t, n, i) {
                var r = ut(t), e = r.cx, u = r.cy, o = t.width / 2;
                return rt(e - n, u - i) < o;
              }(e, t, n)
            ) return !1;
            var r = at(e, t, n, c);
            null !== r
              ? o.setActiveColor(r)
              : (o.inputActive = !0, l.hsv = lt(e, t, n), e.onInput(i, e.id));
        ...
        return h(
          ...
          h("div", {
            ...
            style: Object.assign({}, a, {
              ...
              background: "clockwise" === e.wheelDirection
  ...
  var kt = function (i) {
    ...
    return i && (t.__proto__ = i),
      ((t.prototype = Object.create(i && i.prototype)).constructor = t)
        .prototype.addColor = function (t, n) {
